...
export default function getNullishAwareCustomAdapter<T, U extends JsonValue = JsonValue>(adapter: JsonAdapter<NonNullable<T>, NonNullable<U>>): NullishAwareJsonAdapter<T, U> {
	return {
		adaptToJson(value) {
			if (value == null) {
